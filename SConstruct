...
opts.Add(BoolVariable('use_mingw', 'Use the MinGW compiler even if MSVC is configured - only effective on Windows', False))
...
if env['platform'] == 'linux':
    ...
    # Only 64-bit is supported for the macOS target
    if env['bits'] == '32':
